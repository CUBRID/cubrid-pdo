...
$db->exec('CREATE TABLE cubrid_test(id int NOT NULL PRIMARY KEY, val VARCHAR(10), val2 VARCHAR(10))');
$db->exec("INSERT INTO cubrid_test VALUES(1, 'A', 'AA')");
$db->exec("INSERT INTO cubrid_test VALUES(2, 'B', 'BB')");
$db->exec("INSERT INTO cubrid_test VALUES(3, 'C', 'CC')");

$stmt = $db->prepare('SELECT id, val, val2 FROM cubrid_test');

...
$db->exec('CREATE TABLE cubrid_test(id int NOT NULL PRIMARY KEY, classtype int, val VARCHAR(10))');
$db->exec('INSERT INTO cubrid_test VALUES(1, 0, \'A\')'); 
$db->exec('INSERT INTO cubrid_test VALUES(2, 1, \'B\')'); 
$db->exec('INSERT INTO cubrid_test VALUES(3, 2, \'C\')'); 
$db->exec('INSERT INTO cubrid_test VALUES(4, 3, \'D\')'); 
